				...
				<div class="col-sm-12">
					...
					<div class="breadcrumbs">
						<ol class="breadcrumb">
						  ...
						  <li class="active">{{ $section_current }}</li>
						</ol>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-3"> <!--left-sidebar-->
					<!--left-sidebar-->
					@include('layouts._sidebar_cat')
				</div>
				
				<div class="col-sm-9 padding-right">
				
					<div class="features_items"><!--Выбор категории-->
						<h2 class="title text-center">@lang('pages.select_category') <small>@lang('pages.in_section'):</small>
							{{$section_current}}	
						</h2>
						<div class="features_items">
						<?php $count = 0 ?>
						@foreach($categories_sec as $category)
							<?php $count++ ?>
							@if($count % 4 == 1)
								...
								<div class="product-image-wrapper">
									<div class="single-products">
										<div class="productinfo text-center">
											<a href="{{ route('category.show', $category->id) }}" ><img src="/images/categories/{{ $category->code }}.jpg" alt="" /></a>
											<a href="{{ route('category.show', $category->id) }}"><p>{{ $category->title }}</p></a>
										</div>
				...
				@if(!($servicesLidBuy->isEmpty()) || !($servicesLidSell->isEmpty()) || !($servicesMidBuy->isEmpty()) || !($servicesMidSell->isEmpty()) || !($servicesStaBuy->isEmpty()) || !($servicesStaSell->isEmpty()) || !($servicesBuy->isEmpty()) || !($servicesSell->isEmpty()))
					<div class="features_items"><!--Купить услуги-->
						<h2 class="title text-center">@lang('pages.buy_services') <small>@lang('pages.in_section'):</small>
							{{$section_current}}
						</h2>
					...
					<div class="features_items"><!--Продать услуги-->
						<h2 class="title text-center">@lang('pages.sell_services') <small>@lang('pages.in_section'):</small>
							{{$section_current}}	
						</h2>
