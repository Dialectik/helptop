						...
						<ol class="breadcrumb">
						  <li><a href="{{ route('welcome') }}">@lang('layouts.home')</a></li>
						    @if($sell_buy && $sell_buy == 1)
						  	...
						  	@endif
						  <li class="active">Создание новой услуги в разделе "
						  	@if($sell_buy && $sell_buy == 1)
					...
					<form method="POST" action="{{ route('service.store') }}" enctype="multipart/form-data"> 
				      ...
				      <div class="box">
						...
						<div class="box-body">
							<div class="col-sm-12">
								...
								<div class="col-md-4">    
						            ...
						            <div class="form-group">
						              <label>
										<input type='checkbox' class='minimal' name='expandable' id='expandable' value='1' $checked1/> 
						              </label>
						              <label>
						                Расширяемая услуга
						              </label>
						            ...
						            <div class="form-group">
						              <label>
						                <input type='checkbox' class='minimal' name='scalable' id='scalable' value='1' $checked2/>
						              </label>
						              <label>
						                Масштабируемая услуга
						              </label>
				        ...
				        <div class="box-footer col-sm-12">
							...
							<div class="col-sm-4">
					        	<button type="submit" class="btn1 pull-right">
					        		<i class="fa fa-eye"></i>&nbsp;&nbsp;
