...
<head>
    ...
    <meta name="description" content="<?php if(isset($category->description)){ echo $category->description;}else{ echo 'Разместить объявление для продажи услуги. Найти исполнителя. В вашем городе. Надежные поставщики';} ?>">
    <meta name="author" content="">
    <meta name="keywords" content="<?php if(isset($category->keywords)){ echo $category->keywords;}else{ echo 'консультации, бизнес, фриланс, задание, обучение, лечение, спорт, перевозки, такси, автосервис, отдых, хозяйство, еда, театр, кино, растения, животные, отели, туры, салоны, ремонт, уборка, строительные, веб, it, аренда, нотариус, адвокат, страхование';} ?>">
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title><?php if(isset($category_current)){ echo $category_current;} ?></title>
