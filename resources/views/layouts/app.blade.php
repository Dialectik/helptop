...
<head>
    ...
    <meta name="description" content="Разместить объявление для продажи услуги. Найти исполнителя. В вашем городе. Надежные поставщики.">
    <meta name="author" content="">
    <meta name="keywords" content="консультации, бизнес, фриланс, задание, обучение, лечение, спорт, перевозки, такси, автосервис, отдых, хозяйство, еда, театр, кино, растения, животные, отели, туры, салоны, ремонт, уборка, строительные, веб, it, аренда, нотариус, адвокат, страхование">
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>Портал услуг - продать / заказать услуги</title>
