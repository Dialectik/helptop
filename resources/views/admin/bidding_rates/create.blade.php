  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
    	...
    	<form method="POST" action="{{ route('bidding_rates.store') }}">
		  	@csrf
		  
		    <div class="box-header with-border">
		      <h3 class="box-title">Добавляем платную опцию</h3>
		    ...
		    <div class="box-body">
		      ...
		      <div class="col-md-3">  
		        <div class="form-group">
		          ...
		          <input type="text" class="form-control" id="price_start" name="price_start" value="{{old('price_start')}}" required>
		        </div>
		      </div>
		      ...
		      <div class="col-md-3">  
		        <div class="form-group">
		          ...
		          <input type="text" class="form-control" id="price_end" name="price_end" value="{{old('price_end')}}" required>
		        </div>
		      </div>
		      ...
		      <div class="col-md-3">  
		        <div class="form-group">
		          ...
		          <input type="text" class="form-control" id="rate_bidding" name="rate_bidding" value="{{old('rate_bidding')}}" required>
		        </div>
		      </div>
