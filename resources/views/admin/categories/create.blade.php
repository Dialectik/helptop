		        ...
		        <div class="col-md-4">
		         ...
		         <div class="col-md-1">  
			        <div class="form-group">
			          ...
			          <input type="text" class="form-control" id="_code" placeholder="YY" name="_code" disabled>
			          <input type="hidden" class="form-control" id="pre_code" name="pre_code">
			        </div>
			     </div>
		         <div class="col-md-1">  
			        <div class="form-group">
...
<script type="text/javascript">
    $('#section_id').change(function(){
        ...
        if(sectionID){
            ...
            $.ajax({
               type:'GET',
               url: "{{url('/admin/categories/create/getsectioncode')}}?section_id="+sectionID,
...
<!-- Ограничение поля ввода кода категории ДВУМЯ ЦИФРАМИ -->
<script type="text/javascript">
